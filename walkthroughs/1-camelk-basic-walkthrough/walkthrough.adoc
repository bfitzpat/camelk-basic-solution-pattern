...
// task-scoped attributes
:task-context: creating-a-project-in-vscode
...
// end::task-creating-a-project-in-vscode[]

[time=5]
[#check-openshift-for-integration]
== Find Your Running Camel K Integration
// task-scoped attributes
:task-context: check-openshift-for-integration
...
// end::task-check-openshift-for-integration[]
